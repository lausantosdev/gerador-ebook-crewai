...
class BookState(BaseModel):
    title: str = (
        "The Current State of AI in November 2024 - Trends Across Industries"
    )
    book: List[Chapter] = []
    ...
    goal: str = """
        The goal of this book is to provide a comprehensive overview of the current state of artificial intelligence in November 2024.
